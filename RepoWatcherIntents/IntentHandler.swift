...
//  RepoWatcherIntents
//
//  Created by Thomas Prezioso Jr on 1/19/23.
//
...
extension IntentHandler: SelectSingleRepoIntentHandling {
    ...
    func defaultRepo(for intent: SelectSingleRepoIntent) -> String? { "sallen0400/swift-news" }
}
...
extension IntentHandler: SelectTwoReposIntentHandling {
    ...
    func defaultTopRepo(for intent: SelectTwoReposIntent) -> String? { "sallen0400/swift-news" }
    func defaultBottomRepo(for intent: SelectTwoReposIntent) -> String? { "johnsundell/publish" }
}
